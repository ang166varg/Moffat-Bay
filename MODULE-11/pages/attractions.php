...
/*
Bravo Team
Attractions Page for Moffat Bay Lodge
Purpose: Displays island attractions from the database for guests visiting Moffat Bay Lodge.
*/
            ...
            <ul>
                <li>
                    <?php if (isset($_SESSION['first_name'])): ?>
                        <p style="color: #355e3b;">Welcome, <?php echo htmlspecialchars($_SESSION['first_name']); ?> 👋</p>
    ...
    <div class="card-container">
        ...
        <?php else: ?>
            ...
            <div class="card">
                ...
                <p>
                    Attractions are currently unavailable. Please check back later.
                </p>
            </div>
