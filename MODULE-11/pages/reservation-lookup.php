...
$heroImg = '../images/lodge/view1.avif';
?>
<?php
    ...
    <div class="reservation-container">
        <div class="reservation-form">
            ...
            <form method="POST" style="display:flex; gap:10px; margin-bottom:20px;">
                <input type="number" name="reservation_id" class="reservation-input" placeholder="Enter Reservation ID"
            ...
            <?php if ($searchError): ?>
                <p style="color:red; text-align:center;">
                    No reservation found for <?= htmlspecialchars($_SESSION['first_name'] ?? 'you') ?> with that ID. Please
                    try again.
                </p>
            ...
            <?php elseif ($reservation): ?>
                <table>
                    ...
                    <tr>
                        <th>Room</th>
                        <td><?= htmlspecialchars($reservation['room_name']) ?>
                            (<?= htmlspecialchars($reservation['room_type']) ?>)</td>
                    </tr>
                    <tr>
                        <th>Check-In</th>
